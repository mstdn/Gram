<template>
    <button type="button" @click="openModal" class="btn btn-circle btn-ghost btn-sm md:mr-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#a7081a"
